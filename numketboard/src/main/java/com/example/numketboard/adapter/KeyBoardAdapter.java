package com.example.numketboard.adapter;
...
public class KeyBoardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            AbsListView.LayoutParams params=new AbsListView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,(int)h);
            ...
            convertView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    System.out.println("convertView" + finalConvertView.getHeight());
                }
            });
        } else {
